...
OUTPUT_DIR='train_reults/pd_videomae_pretrain_small_patch16_224_frame_16x4_tube_mask_ratio_0.9_e2400'
# Set the path to SSV2 train set. 
DATA_PATH='scripts/ssv2/videomae_vit_small_patch16_224_tubemasking_ratio_0.9_epoch_2400/train.csv'
